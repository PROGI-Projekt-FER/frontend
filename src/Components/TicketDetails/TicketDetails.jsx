      ...
      <Card.Root>
        <Flex>
          <Flex direction={"column"} width={"50%"}>
            ...
            <Card.Body alignItems={"center"}>{ticket.event.title}</Card.Body>
          </Flex>
          <Flex direction={"column"} width={"50%"}>
            <Card.Header alignItems={"center"} fontWeight={"bold"}>
              Category
            </Card.Header>
            <Card.Body alignItems={"center"}>{ticket.category}</Card.Body>
          </Flex>
        </Flex>
        ...
        <Flex>
          ...
          <Flex direction={"column"} width={"50%"}>
            ...
            <Card.Body alignItems={"center"}>{ticket.description}</Card.Body>
          </Flex>
        </Flex>
        ...
        <Flex>
          ...
          <Flex direction={"column"} width={"50%"}>
            ...
            <Card.Body alignItems={"center"}>
              <Text>{ticket.event.venue.location.country}</Text>
              <Text>{ticket.event.venue.location.city}</Text>
              <Text>{ticket.event.venue.location.address}</Text>
            </Card.Body>
          </Flex>
        </Flex>
  ...
  if (ticket.status === "SELL") {
    return (
      <Card.Root>
        ...
        <Card.Body alignItems={"center"}>{ticket.price}</Card.Body>
        <Button width={"10%"} alignSelf={"center"}>
          Sell
        </Button>
      </Card.Root>
    );
